...
<head>
    ...
    <title>@yield('title', 'Đăng nhập - Luma Shoes')</title>
...
<body>
    ...
    <!-- Login -->
    <section class="container forms {{ Request::is('dang-ky') ? 'show-signup' : '' }}">
        @section('auth_form')
            <div class="form login">
                <div class="form-content">
                    ...
                    <div class="form-link">
                        <span>Bạn chưa có tài khoản? <a href="{{ route('signup') }}" class="signup-link">Đăng ký</a></span>
                    </div>
                </div>
            </div>
        @show
