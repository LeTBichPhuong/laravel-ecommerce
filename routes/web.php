...
Route::prefix('admin')->middleware(['auth', 'admin'])->name('admin.')->group(function () {
    ...
    // Product Sizes CRUD
    Route::get('products/{product}/sizes', [AdminController::class, 'indexSizes'])->name('products.sizes.index');
    Route::post('products/{product}/sizes', [AdminController::class, 'storeSize'])->name('products.sizes.store');
    Route::post('products/{product}/sizes/{size}', [AdminController::class, 'updateSize'])->name('products.sizes.update');
    Route::delete('products/{product}/sizes/{size}', [AdminController::class, 'destroySize'])->name('products.sizes.destroy');
...
Route::get('/san-pham/gioi-tinh/{gender}', [ProductController::class, 'showByGender'])
    ->where('gender', 'Men|Women|Unisex')
    ->name('products.gender');
Route::get('/san-pham', [ProductController::class, 'index'])->name('products.list');
Route::get('/san-pham/quick-view/{id}', [ProductController::class, 'quickView'])->name('products.quick-view');
